        ...
        <div className="max-w-7xl mx-auto">
          {loading && items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-[50vh]">
              ...
              <span className="mt-6 text-[11px] font-black text-slate-400 uppercase tracking-[0.4em]">Loading Registry...</span>
            </div>
            ...
            <div className="flex flex-col items-center justify-center h-[40vh] text-slate-400 border-2 border-dashed border-slate-200 rounded-3xl">
              ...
              <p className="text-sm font-bold uppercase tracking-widest">No matching media entries found</p>
            </div>
          ) : (
          ...
          <div className="relative w-full max-w-6xl h-full max-h-[85vh] bg-[#1E293B] rounded-2xl overflow-hidden shadow-2xl border border-white/10 flex flex-col lg:flex-row">
            ...
            <div className="flex-[3] bg-black/20 relative flex items-center justify-center">
              ...
              {selectedMedia.resourceType === "video" ? (
                <video controls autoPlay className="w-full h-full object-contain" src={selectedMedia.url} />
              ) : (
                <img src={selectedMedia.url} alt="Full view" className="w-full h-full object-contain p-4" />
              )}
            </div>
            ...
            <div className="flex-1 min-w-[320px] bg-[#1E293B] p-8 flex flex-col border-l border-white/5">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-6">
                  <span className="text-[10px] font-black text-[#EFBF04] uppercase tracking-[0.3em]">Registry Secure View</span>
                </div>

                <div className="space-y-6">
                  <div>
                    <h4 className="text-[10px] font-black text-white/30 uppercase tracking-widest mb-2">Description</h4>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[9px] font-black text-white/30 uppercase">Filed On</p>
                        <p className="text-sm font-bold text-white">{new Date(selectedMedia.createdAt).toLocaleDateString()}</p>
                      </div>
                    </div>
                  </div>
                </div>
